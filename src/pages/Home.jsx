...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>Dapoer Niswah – Jamu Tradisional Premium</title>

        <meta
          name="description"
          content="Jamu tradisional premium dari Dapoer Niswah, terbuat dari rempah alami pilihan."
        />

        <link rel="canonical" href="https://dapoerniswah.vercel.app/" />
      </Helmet>
      <div>
        {/* HERO SECTION */}
        <section
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-black text-[var(--color-krem)] mb-6 leading-tight">
              Dapoer{" "}
              <em className="text-[var(--color-kuning)] italic">Niswah</em>
            </h1>
            ...
            <div>
              ...
              <div className="space-y-4 text-[var(--color-krem)]/70 text-sm md:text-base leading-relaxed mb-10">
                <p>
                  ...
                  kesehatan tradisional, didirikan pada 27 Maret 2017 oleh
                  Niswah Lestari. Berawal dari kepedulian untuk menghadirkan
                  minuman herbal yang praktis, higienis, dan tetap autentik.
                </p>
                <p>
                  Setiap produk kami dibuat dengan tangan yang teliti,
                  menggunakan rempah-rempah segar pilihan dari petani lokal.
                  Tidak ada bahan pengawet, tidak ada pewarna buatan — hanya
                  kebaikan alam yang murni untuk keluarga Anda.
                </p>
              </div>
